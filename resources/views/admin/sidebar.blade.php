<div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        {{-- <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('imgs\qnq_logo.png') }}" alt="logo" /></a> --}}
        {{-- <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="{{ asset('imgs\qnq_logo.png') }}" alt="logo" /></a> --}}
      </div>
      <ul class="nav">
          ...
          <div class="profile-desc">
            <div class="profile-pic">
              <div class="count-indicator">
                <img class="img-xs rounded-circle " src="{{ asset('imgs\qnq_logo.png') }}" alt="">
